  ...
  <div class="row">
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_input_system_size">System Size (kW)</label>
      ...
      <!-- Input Daytime Usage -->
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_input_daytime_usage">Daytime Usage</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
      ...
      <!-- Input Power Price -->
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_input_power_price">Power Price (Kw)</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
          <div class="input-group">
            <span class="input-group-addon">$</span>
      ...
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_input_feed_in_tariff">Feed In Tariff</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
          <div class="input-group">
            <span class="input-group-addon">$</span>
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_input_system_loss_factor">System Loss Factor</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
          <div class="input-group">
      ...
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_select_battery_offered">Battery Offered</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
      ...
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_select_battery_model">Battery Model</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
      ...
      <div class="form-group row">
        <label class="col-sm-5 col-md-12 col-lg-12 control-label" for="pse_input_smoothing_rate">Smoothing Rate</label>
        <div class="col-sm-7 col-md-12 col-lg-12">
          <div class="input-group">
